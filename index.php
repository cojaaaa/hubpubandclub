	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="services.php" class="nav-link">?</a></li>
	          <a class="navbar-brand" href="index.php"><img src="images/logo.png"></a>
			  <li class="nav-item"><a href="jelovnik.php" class="nav-link">Jelovnik(radi se)</a></li>
...
Dakle, naš zadatak je jasan, tradicija se mora nastaviti. Jednoga dana će sledeće generacije pisati o tome kako je u Hipi dolini, odmah preko puta nekadašnje diskoteke Trinaestica, decembra 2018. otvoren i čuveni niški Club & Pub, kultni The Hub :-)</p>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row align-items-center">
	            ...
	            <p><a href="jelovnik.html" class="btn btn-primary btn-outline-primary px-4 py-3">Karta pića</a><a href="jelovnik.html" class="btn btn-primary btn-outline-primary px-4 py-3">Jelovnik</a></p>
	          </div>
    			</div>
    			<div class="col-md-6">
    				<div class="row">
    ...
    <section class="ftco-gallery">
    	...
    	<div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-4">Naše proizvode</h2>
            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
          </div>
        </div>
    ...
    <section class="ftco-section img" id="ftco-testimony" style="background-image: url(images/hub-naslovna.jpg);"  data-stellar-background-ratio="0.5">
    	<div class="overlay"></div>
	    <div class="container">
	      <div class="row justify-content-center mb-5">
	        <div class="col-md-7 heading-section text-center ftco-animate">
    	...
    	<div class="container-wrap">
    		<div class="row no-gutters d-md-flex align-items-center">
    			<div class="col-md-6 d-flex align-self-stretch">
    				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2902.7170793196706!2d21.896066415487013!3d43.32018167913404!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4755b1326503f4e5%3A0x85ef6a2bb4d47dea!2sThe%20Hub%20-%20pub%20and%20club!5e0!3m2!1sen!2srs!4v1632920256833!5m2!1sen!2srs" width="1000" height="500" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    			</div>
  ...
  Copyright &copy; <script>document.write(new Date().getFullYear());</script>    Coja </p>
